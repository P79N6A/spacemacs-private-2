...
#+BEGIN_SRC sh
  ...
  #clone dinghmcn layer and checkout develop branch
  git clone https://github.com/dinghmcn/spacemacs-private.git ~/.spacemacs.d/
#+END_SRC
...
1. 我的配置主要分成 5 个 layer
  - dinghmcn-ui: 定制 mode-line，font face 等配置。
  - dinghmcn-programming：和编程相关的配置。
  - dinghmcn-misc：一些杂项，不属于其它分类的都放在这里面。
  - dinghmcn-org：和 org 相关的配置
  - dinghmcn-better-defaults: 增强 Emacs 自带的 package 和功能

2. Spacemacs Rocks 系统视频演示：https://github.com/dinghmcn/Spacemacs-rocks/issues/5 , 让你从此爱上 Emacs :smile:
