;;; packages.el --- dinghm-ui layer packages file for Spacemacs.
;;
...
(defconst dinghmcn-ui-packages
  '(
    (dinghm-mode-line :location built-in)
    diminish
    popwin
...
(defun dinghmcn-ui/init-dinghm-mode-line ()
  (defun dinghmcn/display-mode-indent-width ()
...
(defun dinghmcn-ui/post-init-spaceline ()
...
(defun dinghmcn-ui/init-evil-vimish-fold ()
...
(defun dinghmcn-ui/post-init-whitespace ()
  (progn
