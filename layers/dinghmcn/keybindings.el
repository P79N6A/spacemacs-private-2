;;; keybindings.el --- dinghmcn Layer packages File for Spacemacs
;;
...
(global-set-key [(shift return)] 'dinghmcn/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "<f8>") 'dinghmcn/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'dinghmcn/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'dinghmcn/run-current-file)
...
;; (bind-key* "s-r" 'dinghmcn/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'dinghmcn/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'dinghmcn/delete-semicolon-at-the-end-of-this-line)
...
(global-set-key (kbd "<f1>") 'dinghmcn/helm-hotspots)
(spacemacs/set-leader-keys "oo" 'dinghmcn/helm-hotspots)

(spacemacs/set-leader-keys "oc" 'my-auto-update-tags-when-save)
;; (spacemacs/set-leader-keys "op" 'dinghmcn/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'dinghmcn/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "oll" 'dinghmcn/load-my-layout)
