...
(defun dinghmcn/smart-open-line ()
...
(defun dinghmcn/rename-file-and-buffer ()
...
(defun dinghmcn/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun dinghmcn/dired-do-command (command)
...
(defun dinghmcn/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun dinghmcn/insert-space-after-point ()
  (interactive)
