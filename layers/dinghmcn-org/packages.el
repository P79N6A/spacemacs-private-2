...
;; added to `dinghmcn-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `dinghmcn-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `dinghmcn-org/pre-init-PACKAGE' and/or
;;   `dinghmcn-org/post-init-PACKAGE' to customize the package as it is loaded.
...
(defconst dinghmcn-org-packages
  '((org :location built-in)
    deft)
  "The list of Lisp packages required by the dinghmcn-org layer.
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline (concat org-directory "/task.org") "Workspace")
              ...
              ("f" "Firefox" entry (file+headline (concat org-directory "/inbox.org") "Quick notes")
               "* TODO [#C] %?\n %(dinghmcn/retrieve-firefox-current-tab-url)\n %i\n %U"
               :empty-lines 1)
              ("l" "links" entry (file+headline (concat org-directory "/inbox.org") "Quick notes")
               "* TODO [#C] %?\n  %i\n %a \n %U"
               :empty-lines 1)
              ("j" "Journal Entry"
